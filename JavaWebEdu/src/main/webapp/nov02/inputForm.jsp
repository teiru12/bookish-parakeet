				...
				<table width="500px;">
					...
					<tr>
						...
						<td>
							...
							<input type="button" name="confirm_id" value="ID 중복확인" class="inputBtn"
								onclick="javascript:openconfirmid(this.form);" />
						</td>
					</tr>
					<tr>
						<th>비밀번호</th>
					...
					<tr> 
						<th>주민등록 번호</th>
						<td>
							<input type="text" name="jumin1" maxlength="6" /> -	<input type="password" name="jumin2" maxlength="7" />
						</td>
					</tr>
					<tr> 
						<th>E-mail</th>
						<td>
							<input type="email" name="email" class="w300" maxlength="30" />
						</td>
					</tr>
					<tr> 
						<th>Blog</th>
					...
					<tr> 
						...
						<td>
							...
							<input type="button" value="우편번호 검색" class="inputBtn"
								onclick="javascript:zipCheck();" />
